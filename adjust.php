...
.table-container {
    ...
    border: 1px solid #e1f505; /* Tambahkan border jika diperlukan */
    border-radius: 5px; /* Tambahkan border-radius untuk sudut yang membulat */
    background-color: #e1f505; /* Warna latar belakang container */
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <a class="navbar-brand" href="#">Adjustment</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item">
                    <button id="showModalBtn" class="btn btn-primary">Part Adjust</button>
                </li>
            </ul>
        </div>
    </nav>
...
$(document).ready(function() {
    ...
    function loadData() {
        $.ajax({
            url: 'dbadjust.php', // Endpoint yang sesuai
            type: 'GET',
            dataType: 'json',
