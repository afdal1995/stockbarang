...
.table-container {
    ...
    border: 1px solid #f20202; /* Tambahkan border jika diperlukan */
    border-radius: 5px; /* Tambahkan border-radius untuk sudut yang membulat */
    background-color: #f20202; /* Warna latar belakang container */
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item">
                    <button id="showModalBtn" class="btn btn-primary">Part OUT</button>
                </li>
            </ul>
        </div>
    </nav>
...
$(document).ready(function() {
    ...
    function loadData() {
        $.ajax({
            url: 'dbkeluar.php', // Endpoint yang sesuai
            type: 'GET',
            dataType: 'json',
